            ...
            <table style={tableStyle}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ ...cellStyle, textAlign: 'justify', textJustify: 'inter-word', wordBreak: 'break-word', hyphens: 'auto' }}>{doc.location || '(Location like name of the place, village, city registration, sub-district etc.)'}</td>
                </tr>
                <tr>
                ...
                {doc.customMeasurements && Object.entries(doc.customMeasurements).map(([label, value], idx) => (
                  <tr key={label}>
                    <td style={cellStyle}>xv{idx > 0 ? ` + ${idx}` : ''}</td>
